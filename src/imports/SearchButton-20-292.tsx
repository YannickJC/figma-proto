import svgPaths from "./svg-8k3765g2uc";

function Frame1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-[1_0_0] flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#cbd5e1] text-[12px] text-ellipsis whitespace-nowrap">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[35px] items-start min-h-px min-w-px relative">
      <div className="flex flex-[1_0_0] flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[14px] text-ellipsis text-white w-full whitespace-nowrap">
